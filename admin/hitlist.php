 ...
 * Show upload form
 * @return Status
 * @internal param Place $In admin show upload plistform
    ...
    if ($oa_listtype == '0') {
        ...
        foreach ($output as $var) {
            ...
            $sql               = 'INSERT INTO '
                                 ...
                                 . " (oa_songid, oa_songsong, oa_songtime, oa_songday, oa_songweek, oa_songyear, oa_songplaytime) VALUES ('', "
                                 . $xoopsDB->quoteString(htmlspecialchars($tmp[3], ENT_QUOTES))
                                 . ', '
                                 . $xoopsDB->quoteString($date)
                                 . ', '
                                 . $xoopsDB->quoteString($dayname)
                                 . ', '
                                 . $xoopsDB->quoteString($weekname)
                                 . ', '
                                 . $xoopsDB->quoteString($year)
                                 . ', '
                                 . $xoopsDB->quoteString($playtime)
                                 . ')';
    ...
    if ($oa_listtype == '1') {
        ...
        foreach ($output as $var) {
            ...
            $sql = 'INSERT INTO '
                   . $xoopsDB->prefix('oa_hitlist')
                   . " (oa_songid, oa_songsong, oa_songtime, oa_songday, oa_songweek, oa_songyear, oa_songplaytime) VALUES ('', "
                   . $xoopsDB->quoteString($oa_songsong)
                   . ', '
                   . $xoopsDB->quoteString($oa_date)
                   . ', '
                   . $xoopsDB->quoteString($dayname)
                   . ', '
                   . $xoopsDB->quoteString($oa_weekname)
                   . ', '
                   . $xoopsDB->quoteString($year)
                   . ', '
                   . $xoopsDB->quoteString($playtime)
