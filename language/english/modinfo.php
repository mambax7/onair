...
define('_MI_ONAIR_SHOTDIR', 'Location for screenshots');
define('_MI_ONAIR_IMGDIR', 'Location for images');
...
define('_MI_ONAIR_PROGRAM_EDIT', 'Management');//Show/Edit/Delete/Approve
...
define('_MI_ONAIR_PLUGINDIR_SP_DESC',
       'The file must be in txt-format and located somewhere on your server.<br> If you like you can also show info from another server, but keep it simple<br> only 1 - 2 lines of text otherwise this will be too much info for the block,<br> and the block will be too crowded with text.');
